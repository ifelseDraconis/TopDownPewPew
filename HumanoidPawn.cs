...
public class HumanoidPawn : Pawn
{
    ...
    public void tryFiring()
    {
        if(equippedWeapon != null)
        {
            equippedWeapon.tryFiring();
        }
    }

    public void fireRapid()
    {
        if(equippedWeapon != null)
        {
            equippedWeapon.FireThree();
        }
    }
    ...
    public void iDiedDropMyGun()
    {
        if (equippedWeapon != null)
        {
            equippedWeapon.doUnequip();
        }
        //gameObject.GetComponent<HumanoidPawn>().enabled = false;
    }
}
